            ...
            <>
                ...
                <Form onSubmit={this.handleFormSubmit}>
                    ...
                    <Form.Group >
                        ...
                        <Form.Control as="select" onChange={this.handleInputChange} value={this.state.occupation} name="occuaption" type="text" >
                    ...
                    <Form.Group>
                        ...
                        <Form.Control onChange={this.handleInputChange} value={this.state.contactInfo} name="contactInfo" type="text" />
                    </Form.Group>
